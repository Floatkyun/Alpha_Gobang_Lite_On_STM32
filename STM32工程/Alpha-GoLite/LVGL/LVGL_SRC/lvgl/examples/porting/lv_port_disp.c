...
void lv_port_disp_init(void)
{
    ...
    //static lv_color_t buf_1[MY_DISP_HOR_RES * MY_DISP_VER_RES/15];                          /*A buffer for 10 rows*/
    //lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, MY_DISP_HOR_RES *MY_DISP_VER_RES/15);   /*Initialize the display buffer*/

    /* Example for 2) */
    //static lv_disp_draw_buf_t draw_buf_dsc_1;
    //static lv_color_t buf_2_1[MY_DISP_HOR_RES * MY_DISP_VER_RES/50];                        /*A buffer for 10 rows*/
    //static lv_color_t buf_2_2[MY_DISP_HOR_RES * MY_DISP_VER_RES/50];                        /*An other buffer for 10 rows*/
    //lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_2_1, buf_2_2, MY_DISP_HOR_RES * MY_DISP_VER_RES/50);   /*Initialize the display buffer*/
...
{
    /*You code here*/
LCD_Clear_DMA(0xffff);
			LTDC_Layer1->CFBAR = (uint32_t)(LVGL_MemoryAdd);		
