...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_digital_clock_1, 104, 20);
	lv_obj_set_size(ui->screen_digital_clock_1, 170, 60);
	...
	lv_obj_set_style_text_font(ui->screen_digital_clock_1, &lv_font_shouxie_48, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write codes screen_slider_search_num
	ui->screen_slider_search_num = lv_slider_create(ui->screen);
	lv_slider_set_range(ui->screen_slider_search_num, 400, 4000);
	lv_slider_set_mode(ui->screen_slider_search_num, LV_SLIDER_MODE_NORMAL);
	lv_slider_set_value(ui->screen_slider_search_num, 400, LV_ANIM_OFF);
	lv_obj_set_pos(ui->screen_slider_search_num, 15, 319);
	lv_obj_set_size(ui->screen_slider_search_num, 270, 15);

	//Write style for screen_slider_search_num, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_slider_search_num, 60, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_slider_search_num, lv_color_hex(0x34ffa4), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_slider_search_num, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_slider_search_num, 50, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_outline_width(ui->screen_slider_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_slider_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style for screen_slider_search_num, Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_slider_search_num, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_slider_search_num, lv_color_hex(0x34ff98), LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_slider_search_num, LV_GRAD_DIR_NONE, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_slider_search_num, 50, LV_PART_INDICATOR|LV_STATE_DEFAULT);

	//Write style for screen_slider_search_num, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_slider_search_num, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_slider_search_num, lv_color_hex(0x00ed5c), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_slider_search_num, LV_GRAD_DIR_NONE, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_slider_search_num, 50, LV_PART_KNOB|LV_STATE_DEFAULT);

	//Write codes screen_slider_1
	ui->screen_slider_1 = lv_slider_create(ui->screen);
	lv_slider_set_range(ui->screen_slider_1, 1, 40);
	lv_slider_set_mode(ui->screen_slider_1, LV_SLIDER_MODE_NORMAL);
	lv_slider_set_value(ui->screen_slider_1, 1, LV_ANIM_OFF);
	lv_obj_set_pos(ui->screen_slider_1, 15, 250);
	lv_obj_set_size(ui->screen_slider_1, 270, 15);
	...
	lv_obj_set_style_bg_color(ui->screen_slider_1, lv_color_hex(0x34ffa4), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_slider_1, lv_color_hex(0x34ff98), LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_slider_1, lv_color_hex(0x00ed5c), LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_radiobtn, 25, 126);
	...
	lv_label_set_text(ui->screen_btn_1_label, "应用设置");
	lv_label_set_long_mode(ui->screen_btn_1_label, LV_LABEL_LONG_WRAP);
	lv_obj_align(ui->screen_btn_1_label, LV_ALIGN_CENTER, 0, 0);
	lv_obj_set_style_pad_all(ui->screen_btn_1, 0, LV_STATE_DEFAULT);
	lv_obj_set_width(ui->screen_btn_1_label, LV_PCT(100));
	lv_obj_set_pos(ui->screen_btn_1, 63, 379);
	lv_obj_set_size(ui->screen_btn_1, 186, 50);
	...
	lv_obj_set_style_text_font(ui->screen_btn_1, &lv_font_shouxie_32, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_label_1, 35, 102);
	lv_obj_set_size(ui->screen_label_1, 81, 24);

	//Write style for screen_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_shouxie_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_label_2, "探索常数：");
	lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_2, 10, 215);
	lv_obj_set_size(ui->screen_label_2, 137, 24);
	...
	lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_shouxie_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_label_3, "搜索次数：");
	lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_3, 10, 285);
	lv_obj_set_size(ui->screen_label_3, 130, 24);
	...
	lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_shouxie_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write codes screen_label_search_num
	ui->screen_label_search_num = lv_label_create(ui->screen);
	lv_label_set_text(ui->screen_label_search_num, "400");
	lv_label_set_long_mode(ui->screen_label_search_num, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_search_num, 185, 283);
	lv_obj_set_size(ui->screen_label_search_num, 100, 24);

	//Write style for screen_label_search_num, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_label_search_num, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_label_search_num, &lv_font_shouxie_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->screen_label_search_num, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->screen_label_search_num, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->screen_label_search_num, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_label_search_num, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes screen_label_4
	ui->screen_label_4 = lv_label_create(ui->screen);
	lv_label_set_text(ui->screen_label_4, "0.5");
	lv_label_set_long_mode(ui->screen_label_4, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_4, 185, 215);
	lv_obj_set_size(ui->screen_label_4, 100, 24);
	...
	lv_obj_set_style_text_font(ui->screen_label_4, &lv_font_shouxie_24, LV_PART_MAIN|LV_STATE_DEFAULT);
