...
AI_INTERNAL_API
extern void st_mat_init_f32( ai_matrix_f32 * S,
    uint16_t nRows,
    uint16_t nColumns,
    ai_float * pData);
...
/*!
  * @brief general matrix multiplication on float values
