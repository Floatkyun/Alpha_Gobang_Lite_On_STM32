...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "best_policy_value_net_simplify"
...
#define AI_NETWORK_IN_1_SIZE        (486)
#define AI_NETWORK_IN_1_SIZE_BYTES  (1944)
...
#define AI_NETWORK_OUT_1_CHANNEL     (81)
#define AI_NETWORK_OUT_1_SIZE        (81)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (324)
